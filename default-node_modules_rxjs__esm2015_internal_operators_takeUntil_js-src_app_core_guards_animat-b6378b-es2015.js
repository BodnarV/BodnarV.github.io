"use strict";
(self["webpackChunkapp"] = self["webpackChunkapp"] || []).push([["default-node_modules_rxjs__esm2015_internal_operators_takeUntil_js-src_app_core_guards_animat-b6378b"],{
...
let SelectionGuard = class SelectionGuard {
    constructor(_storeService, router) {
...
SelectionGuard = (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__decorate)([
...
/* harmony import */ var _core_configs_routing_config__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @core/configs/routing-config */ 2831);
...
let DataService = class DataService {
    ...
    fetchPagesData(link) {
        return this.http.get(_environments_environment__WEBPACK_IMPORTED_MODULE_0__.environment.API + '/message/' + link)
            .pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.catchError)(err => {
            this.router.navigate([_core_configs_routing_config__WEBPACK_IMPORTED_MODULE_1__.CoreRoutes.LINK_NOT_VALID]);
...
//# sourceMappingURL=default-node_modules_rxjs__esm2015_internal_operators_takeUntil_js-src_app_core_guards_animat-b6378b-es2015.js.map